...
\subsection{Team} 
Samuel Neururer (Leiter, Programmierer, Design) \\
David Urbanz (Programmierer, Design, Fragen)
\subsection{Betreuer}
<<<<<<< HEAD
Dominik Neuner, MSc (Betreuer)
=======
Dominik Neuner, MSc
...
Dominik Neuner, MSc\\
Alexander Scharmer, MA, BEd\\
Mag. Claudio Landerer, Bakk.
