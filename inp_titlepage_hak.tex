...
%\vspace{-30mm}
%\hspace{-4mm}
\includegraphics[height=3cm]{Logo_Feuerwehr} % logo
\end{minipage}
...
\begin{tabular}{ l c r }
  Samuel Neururer & Verantwortlich für IT: HTML, CSS, BWL: Kaufvertrag \\
  David Urbanz & Verantwortlich für IT: HTML, CSS, BWL: Kaufvertrag \\
